...
CREATE TABLE `cargo` (
  ...
  `Nombre_Cargo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `cliente` (
  `ID_Cliente` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Nombre_Cliente` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Tipo_Cliente` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `Contacto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `cotizacion` (
  `ID_Cotizacion` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `cotizacion` VALUES ('C0001','2025-04-27',10000.00),('C0002','2025-04-27',3000.00),('C0003','2025-04-27',8000.00),('C0004','2025-04-27',4500.00),('C0005','2025-04-27',1000.00),('C0006','2025-04-27',15000.00),('C0007','2025-04-27',5000.00),('C0008','2025-04-27',3000.00),('C0009','2025-04-27',6000.00),('C0010','2025-04-27',2000.00),('C0011','2025-04-27',5000.00),('C0012','2025-04-27',12000.00),('C0013','2025-04-27',2000.00),('C0014','2025-04-27',3000.00),('C0015','2025-04-27',3000.00),('C0016','2025-04-27',10000.00),('C0017','2025-04-27',15000.00),('C0018','2025-04-27',4000.00),('C0019','2025-04-27',4500.00),('C0020','2025-04-27',1000.00),('C0021','2025-04-29',600.00),('C0022','2025-04-29',600.00),('C0023','2025-04-29',600.00),('C0024','2025-04-29',600.00),('C0025','2025-04-29',600.00),('C0026','2025-04-29',400.00),('C0027','2025-04-29',450.00);
...
CREATE TABLE `detalle_factura` (
  `ID_Detalle_Factura` char(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ID_Factura` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ID_Pedido` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `detalle_factura` VALUES ('D00001','F0001','P001',1),('D00002','F0002','P002',1),('D00003','F0003','P003',1),('D00004','F0004','P004',1),('D00005','F0005','P005',1),('D00006','F0006','P006',1),('D00007','F0007','P007',1),('D00008','F0008','P008',1),('D00009','F0009','P009',1),('D00010','F0010','P010',1),('D00011','F0011','P011',1),('D00012','F0012','P012',1),('D00013','F0013','P013',1),('D00014','F0014','P014',1),('D00015','F0015','P015',1),('D00016','F0016','P016',1),('D00017','F0017','P017',1),('D00018','F0018','P018',1),('D00019','F0019','P019',1),('D00020','F0020','P020',1),('D0021','F0021','P021',1);
...
CREATE TABLE `detalle_pedido` (
  `ID_Detalle_Pedido` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ID_Pedido` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  KEY `fk_id_cotizacion_detalle` (`ID_Cotizacion`),
  ...
  CONSTRAINT `fk_id_cotizacion_detalle` FOREIGN KEY (`ID_Cotizacion`) REFERENCES `cotizacion` (`ID_Cotizacion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `detalle_pedido` VALUES ('DP00001','P001',1,'C0001'),('DP00002','P002',2,'C0002'),('DP00003','P003',3,'C0003'),('DP00004','P004',4,'C0004'),('DP00005','P005',5,'C0005'),('DP00006','P006',2,'C0006'),('DP00007','P007',1,'C0007'),('DP00008','P008',4,'C0008'),('DP00009','P009',3,'C0009'),('DP00010','P010',5,'C0010'),('DP00011','P011',1,'C0011'),('DP00012','P012',2,'C0012'),('DP00013','P013',3,'C0013'),('DP00014','P014',4,'C0014'),('DP00015','P015',5,'C0015'),('DP00016','P016',1,'C0016'),('DP00017','P017',2,'C0017'),('DP00018','P018',3,'C0018'),('DP00019','P019',4,'C0019'),('DP00020','P020',5,'C0020'),('DP00021','P021',2,'C0016'),('DP00022','P022',2,'C0002'),('DP00023','P023',2,'C0006');
...
CREATE TABLE `empleado` (
  `ID_Empleado` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ID_Cargo` int NOT NULL,
  `Salario` decimal(10,2) NOT NULL,
  `Fecha_Ingreso` date NOT NULL,
  `ID_Sucursal` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `empresa` (
  `ID_Empresa` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `factura` VALUES ('F0001','2023-01-16','P001','S001'),('F0002','2023-03-11','P002','S001'),('F0003','2023-05-21','P003','S001'),('F0004','2023-07-26','P004','S001'),('F0005','2023-09-06','P005','S001'),('F0006','2023-11-13','P006','S001'),('F0007','2024-02-19','P007','S001'),('F0008','2024-04-23','P008','S001'),('F0009','2024-06-08','P009','S001'),('F0010','2024-08-15','P010','S001'),('F0011','2024-10-20','P011','S001'),('F0012','2024-12-26','P012','S001'),('F0013','2025-01-31','P013','S001'),('F0014','2025-03-09','P014','S001'),('F0015','2025-05-17','P015','S001'),('F0016','2025-07-23','P016','S001'),('F0017','2025-09-11','P017','S001'),('F0018','2025-11-16','P018','S001'),('F0019','2025-12-06','P019','S001'),('F0020','2025-12-21','P020','S001'),('F0021','2025-04-30','P021','S001');
...
CREATE TABLE `marca` (
  ...
  `Nombre_Marca` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `material` (
  `ID_Material` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Descripcion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Precio` decimal(10,2) NOT NULL,
  `ID_Proveedor` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pieza` (
  `ID_Pieza` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Descripcion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Tipo_Pieza` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ID_Material` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `proveedor` (
  ...
  `ID_Empresa` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Tipo_Proveedor` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `RUC` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Direccion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Contacto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Correo_Electronico` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `servicio` (
  ...
  `Tiempo_Estimado` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- Dump completed on 2025-04-30 14:00:38
